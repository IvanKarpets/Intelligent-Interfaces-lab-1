...
from PySide2.QtGui import QIntValidator, QPalette, QFont
...
class RentWindow(QWidget):
    def __init__(self):
        ...
        self.ui_widget.flatsTableView.setColumnWidth(0, 140)
        self.ui_widget.flatsTableView.setColumnWidth(1, 160)
        self.ui_widget.flatsTableView.setColumnWidth(2, 80)
        self.ui_widget.flatsTableView.setColumnWidth(3, 160)
        self.ui_widget.flatsTableView.setColumnWidth(5, 160)
        self.ui_widget.flatsTableView.setColumnWidth(6, 100)
    ...
    def estimate_click(self):
        ...
        self.ui_widget.estimateResultLabel.setText(
            "Результат: {} | Вартість: {}".format(output.price_fuzz, output.price))
